 ...
 * @param on — true to lock, false to release
 */
export function lockView(on: boolean): void {
...
export function removeViewReserve(): void {
  state.px = 0;
 ...
 * HA swaps the view.
 * @param px — pixels to reserve at the bottom of the view
 */
export function setViewReserve(px: number): void {
