...
import { FibbersSelect } from "./cards/inputs/select";
import { FibbersToggle } from "./cards/inputs/toggle";
import { FibbersBack } from "./cards/layout/back";
import { FibbersGreeting } from "./cards/layout/greeting";
import { FibbersNav } from "./cards/layout/nav";
import { FibbersRoom } from "./cards/layout/room";
import { FibbersSection } from "./cards/layout/section";
import { FibbersSheet } from "./cards/layout/sheet";
import { FibbersLightDetail } from "./cards/lights/light-detail";
import { FibbersLightGroup } from "./cards/lights/light-group";
import { FibbersLightRow } from "./cards/lights/light-row";
import { FibbersMedia } from "./cards/media/media";
import { FibbersRemote } from "./cards/media/remote";
import { FibbersAlert } from "./cards/sensors/alert";
import { FibbersBackup } from "./cards/sensors/backup";
import { FibbersEntities } from "./cards/sensors/entities";
import { FibbersGraph } from "./cards/sensors/graph";
import { FibbersPresence } from "./cards/sensors/presence";
import { FibbersStat } from "./cards/sensors/stat";
import { FibbersSysmon } from "./cards/sensors/sysmon";
import { FibbersWeather } from "./cards/sensors/weather";
import { bar } from "./core/body-layer";
import { injectGlobalCss } from "./core/global-css";
import { nav, goBack, previous } from "./core/nav-stack";
...
window.customCards ??= [];
const registry = window.customCards;
